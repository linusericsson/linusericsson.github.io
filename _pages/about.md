...
I am a Lecturer in Artificial Intelligence and Machine Learning at the School of Computing Science, University of Glasgow. My research explores AI/ML methods to learn transferable representations of data, building efficient neural networks, and adapting these models across data shifts. Specific interests include representation learning, multi-modality, robustness, and automated machine learning (AutoML), especially with applications to healthcare and the environment.  
...
I am currently seeking PhD students! There are several routes for application (generally with deadlines around January each year), including <a href="https://www.gla.ac.uk/schools/computing/postgraduateresearch/prospectivestudents/">available scholarships</a> within the School of Computing Science and the <a href="https://www.divein.org.uk/">DiveIn CDT</a>. Please take a look at my publications to see if our research interests align, and feel free to get in touch by email if you’d like to work with me.  
<br><br>
For postdoc interests, the <a href="https://marie-sklodowska-curie-actions.ec.europa.eu/actions/postdoctoral-fellowships">MSCA Postdoctoral Fellowships</a> can support applicants from outside the UK. Get in touch if you're interested in applying.
